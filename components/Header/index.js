...
const Header = ({ handleHomeScroll, handleAboutScroll, handleSkillScroll, handleExperienceScroll, handleProjectScroll }) => {
    ...
    return (
        <>
            <Popover className="block tablet:hidden mt-5"> {({ open }) => (
                    <>
                        <div className="flex items-center justify-between p-2 laptop:p-0">
                            ...
                            <div className="flex items-center">
                                ...
                                <Popover.Button>
                                    <img className="h-5" src={`/images/${!open ? theme === "dark" ? "menu-white.svg" : "menu.svg" : theme === "light" ? "cancel.svg" : "cancel-white.svg" }`} ></img>
                                </Popover.Button>
                            </div>
                        </div>
